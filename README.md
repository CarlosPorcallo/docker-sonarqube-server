This is a [`SonarQube Server`](https://www.sonarsource.com/products/sonarqube/) project launched with [`Docker`](https://www.docker.com) and [`Docker Compose`](https://docs.docker.com/compose/).
